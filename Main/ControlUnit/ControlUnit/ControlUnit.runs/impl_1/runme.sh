...
HD_PWD='C:/Users/Justin/Desktop/ControlUnit/ControlUnit/ControlUnit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ControlUnit.vdi -applog -m64 -messageDb vivado.pb -mode batch -source ControlUnit.tcl -notrace
