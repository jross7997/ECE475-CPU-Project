...
HD_PWD='C:/Users/Justin/Desktop/ControlUnit/ControlUnit/ControlUnit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ControlUnit.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ControlUnit.tcl
