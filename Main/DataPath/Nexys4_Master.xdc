...
set_property PACKAGE_PIN U9 [get_ports {Hex0In[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Hex0In[0]}]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
set_property PACKAGE_PIN U8 [get_ports {Hex0In[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Hex0In[1]}]
#Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
set_property PACKAGE_PIN R7 [get_ports {Hex0In[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Hex0In[2]}]
#Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = SW3
set_property PACKAGE_PIN R6 [get_ports {Hex0In[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Hex0In[3]}]
##Bank = 34, Pin name = IO_L19N_T3_VREF_34,					Sch name = SW4
#set_property PACKAGE_PIN R5 [get_ports {Hex0In[4]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Hex0In[4]}]
...
set_property PACKAGE_PIN E16 [get_ports blank_in]						
	set_property IOSTANDARD LVCMOS33 [get_ports blank_in]
