...
HD_PWD='C:/Users/jross5/Desktop/DataPath/MainMemory/MainMemory.runs/MainMemory_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MainMemory.vds -m64 -mode batch -messageDb vivado.pb -notrace -source MainMemory.tcl
