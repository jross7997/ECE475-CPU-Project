...
HD_PWD='C:/Users/Justin/Desktop/DataPath/mux2_to_1_64/mux2_to_1_64.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux2_to_1_64.vdi -applog -m64 -messageDb vivado.pb -mode batch -source mux2_to_1_64.tcl -notrace
