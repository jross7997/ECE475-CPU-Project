...
HD_PWD='C:/Users/Justin/Desktop/DataPath/RAMcontroller/RAMcontroller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log display_num.vds -m64 -mode batch -messageDb vivado.pb -notrace -source display_num.tcl
