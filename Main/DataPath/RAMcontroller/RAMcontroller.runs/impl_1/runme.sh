...
HD_PWD='C:/Users/Justin/Desktop/DataPath/RAMcontroller/RAMcontroller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log display_num.vdi -applog -m64 -messageDb vivado.pb -mode batch -source display_num.tcl -notrace
