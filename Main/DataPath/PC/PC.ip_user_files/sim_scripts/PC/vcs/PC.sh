...
# executing this script. Please type 'PC.sh -help' for more information.
#
...
reset_run()
{
  files_to_remove=(ucli.key PC_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc PC_simv.daidir)
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../PC.srcs/sources_1/ip/PC/sim/PC.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.PC -o PC_simv
}
