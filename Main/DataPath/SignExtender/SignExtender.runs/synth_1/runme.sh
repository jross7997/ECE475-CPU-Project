...
HD_PWD='C:/Users/Justin/Desktop/DataPath/SignExtender/SignExtender.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SignExtender.vds -m64 -mode batch -messageDb vivado.pb -notrace -source SignExtender.tcl
