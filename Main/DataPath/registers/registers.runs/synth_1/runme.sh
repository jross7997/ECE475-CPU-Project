...
HD_PWD='C:/Users/jross5/Desktop/Steding_Ross_Lab6/Lab6_1/registers/registers.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log register_file.vds -m64 -mode batch -messageDb vivado.pb -notrace -source register_file.tcl
