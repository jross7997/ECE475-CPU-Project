...
HD_PWD='C:/Users/Justin/Desktop/DataPath/adder64/adder64.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder64.vds -m64 -mode batch -messageDb vivado.pb -notrace -source adder64.tcl
