...
HD_PWD='C:/Users/jross5/Desktop/DataPath/InstructionMemory/InstructionMemory.runs/InstructionMemory_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log InstructionMemory.vds -m64 -mode batch -messageDb vivado.pb -notrace -source InstructionMemory.tcl
