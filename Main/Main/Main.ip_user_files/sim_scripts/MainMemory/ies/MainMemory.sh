...
#
# Generated by Vivado on Thu May 03 19:19:26 -0400 2018
...
compile()
{
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../../DataPath/MainMemory/MainMemory.srcs/sources_1/ip/MainMemory/sim/MainMemory.vhd" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.MainMemory $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.MainMemory -input simulate.do
}
# Script usage
usage()
{
