...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {manClock}] 
...
set_property PACKAGE_PIN E16 [get_ports manClock]						
	set_property IOSTANDARD LVCMOS33 [get_ports manClock]
